...
#SBATCH --output=report-bwa-Am2-switch
#SBATCH --mail-user=christina.wesse.osnabrueck@gmail.com
#SBATCH --mail-type=ALL
#SBATCH --job-name="Am2-switch-CBP-Trim-BWA"
...
samFolder="pseudoref-samresults-Am2-switch"
...
#create_sam_file "demux-jobs/Am1-switch/"
create_sam_file "demux-jobs/Am2-switch/"
